...
/***
 * @name getJanisHeaders
 * @description returns the device data mapped to the janis-app-* headers
 * @returns {object}
 * @example getJanisHeaders() => {
 *  'janis-app-name':'janis app',
 *  'janis-app-build':'0',
 *  'janis-app-version':'1.22.0',
 *  'janis-app-package-name':'in.janis.picking',
 *  'janis-app-device-os-name':'android',
 *  'janis-app-device-os-version':'13',
 *  'janis-app-device-id':'12345',
 *  'janis-app-device-name':'samsung',
 * }
 */

export const getJanisHeaders = () => {
	const {
		applicationName,
		buildNumber,
		appVersion,
...
const REACHABILITY_URLS = {
	janis: 'https://app.janis.in',
	janisqa: 'https://app.janisqa.in',
	janisdev: 'https://app.janisdev.in',
};

/***
 * @name getReachabilityUrl
 * @description returns the connectivity check url that matches the current environment
 * @returns {string}
 * @example getReachabilityUrl() => 'https://app.janisqa.in'
 */

export const getReachabilityUrl = () =>
	REACHABILITY_URLS[getEnvironment()] ?? REACHABILITY_URLS.janis;
